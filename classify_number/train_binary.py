...
import numpy as np
from dataset.dataset2 import MyDataset
...
root_dir = '/raid/AI_lai/share/wb/dataset/generate_data_iou0.1_0.3/'
train_label_path = '/raid/AI_lai/share/wb/dataset/generate_data_iou0.1_0.3/train.csv'
val_label_path = '/raid/AI_lai/share/wb/dataset/generate_data_iou0.1_0.3/validate.csv'
...
def main():
    ...
    for epoch in range(epochs):
        ...
        if val_accurate > best_acc:
            ...
            print('=============Best acc============')
            torch.save(net.state_dict(), './pkl/resnet_class4_sz512_iou0.1_0.3' + '.pkl')

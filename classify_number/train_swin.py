...
from model.swin import swin_base_patch4_window7_224,swin_tiny_patch4_window7_224,swin_small_patch4_window7_224
...
root_dir = '/raid/AI_lai/share/wb/dataset/generate_data_v2/'
train_label_path = '/raid/AI_lai/share/wb/dataset/generate_data_v2/train.csv'
val_label_path = '/raid/AI_lai/share/wb/dataset/generate_data_v2/validate.csv'
...
def main():
    ...
    for epoch in range(epochs):
        ...
        for step, (X, y) in enumerate(train_bar):
            ...
            for n, p in net.named_modules():
                ...
                if isinstance(p, nn.Conv2d):
                    ...
                    regular_loss += torch.sum(p.weight)
        ...
        if val_accurate > best_acc:
            ...
            print('=============Best acc============')
            torch.save(net.state_dict(), './pkl/swin_class4_sz224' + '.pkl')

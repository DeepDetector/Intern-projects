...
if __name__ == '__main__':
    ...
    all_images = sorted(glob('/home/ubt/data/detection/20211207_online_test/val/JPEGImages/*.jpg'))
    gt_root = '/home/ubt/data/detection/20211207_online_test/val/Annotations/'
    # pred_root = 'D:/Projects/mAP/input/dt_results/yolo_cp_past/'
    pred_root = 'yolo_origin_ib_new_ds/normal/'
    ...
    # print(all_scores)
    thd, prec_thd, rec_thd, det_gt_maps = eval_recall_at_precision(all_images, all_gt_boxes, all_gt_labels, all_results, all_scores, 0.7, 10, 0.1, small_obj=True, all_gt_ignores=all_gt_ignores)

...
#     root_folder = '/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/CrowdHuman/'
#     image_folder = '/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/CrowdHuman/Images'
#     train_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/CrowdHuman/annotation_val.odgt')
#     eval_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/CrowdHuman/annotation_val.odgt')

class Crowd_human:
    class_names = ['background','something']
    num_classes = len(class_names)
    root_folder = '/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/online_data/'
    image_folder = '/raid/AI_lai/share/wb/code/CrowdDet-master/'
    train_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/annotations_tarin.odgt')
    eval_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/annotations_tarin.odgt')

class Config:
    output_dir = 'outputs'
    model_dir = os.path.join(output_dir, 'model_dump')
    eval_dir = os.path.join(output_dir, 'eval_dump')
    init_weights = '../pkl/resnet50_fbaug.pth'

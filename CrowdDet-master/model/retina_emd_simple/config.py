...
class Crowd_human:
    ...
    train_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/online_data/annotations_tarin.odgt')
    eval_source = os.path.join('/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/online_data/annotations_tarin.odgt')

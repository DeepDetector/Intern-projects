...
def inference(args, config, network):
    ...
    fpath = '../outputs_vs/{}.png'.format(name)
...
def run_inference():
    ...
    parser.add_argument('--resume_weights', '-r', default='30', required=False, type=str)
    ...
    imgdir = '/raid/AI_lai/share/wb/code/CrowdDet-master/dataset/testdata/test/JPEGImages/'
    outdir = '../outputs_vs/'
